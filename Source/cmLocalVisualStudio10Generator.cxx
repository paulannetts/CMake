...
void cmLocalVisualStudio10Generator::Generate()
{
  ...
  for(cmTargets::iterator l = tgts.begin(); l != tgts.end(); ++l)
    ...
    if(static_cast<cmGlobalVisualStudioGenerator*>(this->GlobalGenerator)
      ...
      cmGlobalVisualStudio11Generator* vs11Gen = dynamic_cast<cmGlobalVisualStudio11Generator*> (this->GlobalGenerator);
      if (vs11Gen != NULL)
        {
        cmsys::auto_ptr<cmVisualStudio11MultiPlatformTargetGenerator> 
          tg11 (new cmVisualStudio11MultiPlatformTargetGenerator(&l->second, vs11Gen));
        tg = tg11;
        }
      else
        {
        cmGlobalVisualStudio10Generator* vs10Gen = static_cast<cmGlobalVisualStudio10Generator*>
